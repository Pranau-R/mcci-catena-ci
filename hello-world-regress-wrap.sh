...
##############################################################################
#
# Module: hello-world-regress-wrap.sh
#
# Function:
...
function ci_hello-world-arduino_generic {
    ...
    for iSketch in "$@"; do
        ...
        MCCI_CI_FILTER_NAME="$(dirname "$iSketch")/extra/ci/hello-world-arduino-filter.sh"
...
function ci_samd {
    ...
    ci_hello-world-arduino_generic "$@"
}
...
function _main {
    ...
    _setup_path
    # _setup_hello_world_arduino libraries/hello-world-arduino
    _setup_lmic libraries/hello-world-arduino
    _setup_arduino_cli
